...
modified: 
categories: blog
excerpt: After USA, Spain, France the summer and winter weather in the Netherlands was plotted. 
tags: [XKCD, weather, humidex, dplyr, ggplot2, readr, Netherlands]
image:
date: 2017-11-20
---
...
![Netherlands, weatherplot XKCD style]({{ site.github.url }}/images/xkcd_NL_US_ESP.png)
...
![temperature ranges in the Netherlands alone]({{ site.github.url }}/images/temperatureranges-in-the-netherlands-1.png)
...
```
![Netherlands, humidex, gps]({{ site.github.url }}/images/humidex_NL.png)
![Netherlands, wintertemp, gps]({{ site.github.url }}/images/wintertemp_NL.png)
